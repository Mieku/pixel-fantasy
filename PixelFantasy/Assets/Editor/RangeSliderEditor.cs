...
public class RangeSliderEditor : SelectableEditor
{
	...
	private SerializedProperty _middleHandle;
	private SerializedProperty _minHandleOffset;
	private SerializedProperty _maxHandleOffset;
	...
	private SerializedProperty _minHandleImage;
	private SerializedProperty _maxHandleImage;
	...
	protected override void OnEnable()
	{
		...
		_middleHandle = serializedObject.FindProperty("middleHandle");
		_minHandleOffset = serializedObject.FindProperty("minHandleOffset");
		_maxHandleOffset = serializedObject.FindProperty("maxHandleOffset");
		...
		_minHandleImage = serializedObject.FindProperty("minHandleImage");
		_maxHandleImage = serializedObject.FindProperty("maxHandleImage");
	...
	public override void OnInspectorGUI()
	{
		...
		EditorGUILayout.PropertyField(_middleHandle);
		
		EditorGUILayout.PropertyField(_minHandleImage);
		EditorGUILayout.PropertyField(_maxHandleImage);
		EditorGUILayout.PropertyField(_fillImage);
		EditorGUILayout.PropertyField(_selectedColour);

		EditorGUILayout.PropertyField(_minText);
		EditorGUILayout.PropertyField(_maxText);
		EditorGUILayout.PropertyField(_textFormat);
		
		EditorGUILayout.PropertyField(_minHandleOffset);
		EditorGUILayout.PropertyField(_maxHandleOffset);
		...
		if (anyValueChanged)
		{
			RangeSlider slider = (RangeSlider)target;
