...
namespace InfinityPBR.Modules.Inventory
{
    ...
    public class ItemWorld : MonoBehaviour
    {
        ...
        public virtual GameItemObject GameItemObject() => gameItemObject;

        public virtual GameItemObject SetGameItemObject(GameItemObject value)
        {
            gameItemObject = value;
            Debug.Log($"Original: UId is {gameItemObject.Uid()}");
