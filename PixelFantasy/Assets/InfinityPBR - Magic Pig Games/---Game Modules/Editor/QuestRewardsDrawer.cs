...
{
    public class QuestRewardsDrawer : GameModulesDrawer
    {
        // -------------------------------
        ...
        private string DocsURL => "https://infinitypbr.gitbook.io/infinity-pbr/game-modules/quests/quest-rewards";
        private string DocsURLLabel => "Quest Rewards";
        ...
        // -------------------------------
        public void SetModulesObject(QuestReward modulesObject, bool drawnByWindow = true)
        {
        ...
        public void Draw()
        {
            ...
            foreach (var drawer in _questRewardDrawers) // This needs to be defined and filled appropriately.
            {
