...
{
    public class VoicesDrawer : GameModulesDrawer
    {
        // -------------------------------
        ...
        private string DocsURL => "https://infinitypbr.gitbook.io/infinity-pbr/game-modules/voices";
        private string DocsURLLabel => "Voices";
        ...
        // -------------------------------
        public void SetModulesObject(Voices modulesObject, bool drawnByWindow = true)
        {
        ...
        public void Draw()
        {
            ...
            {
                LabelGrey("Voices - " + _modulesObject.objectType);
        ...
        {
            if (!HasKey(name + " " + _menuBarOptions[0])) 
                SetBool(name + " " + _menuBarOptions[0], true);
        ...
        {
            StartRow();
            for (int i = 0; i < _menuBarOptions.Length; i++)
            {
                BackgroundColor(GetBool(name + " " + _menuBarOptions[i]) ? active : dark);
                if (Button(_menuBarOptions[i]))
                {
                    for (int b = 0; b < _menuBarOptions.Length; b++)
                    {
                        if (b == i)
                            SetBool(name + " " + _menuBarOptions[b], !GetBool(name + " " + _menuBarOptions[b]));
                        else
                            SetBool(name + " " + _menuBarOptions[b], false);
                    }
                }
            }
            ResetColor();
        ...
        public void DisplayTypes()
        {
            ...
            for (int i = 0; i < _modulesObject.types.Count; i++)
            {
                ...
                if (_modulesObject.types.Count > 1)
                {
                    if (XButton())
                    {
                        Undo.RecordObject(_modulesObject, "Delete Type");
                        foreach (Voice voice in _modulesObject.voices)
                        {
        ...
        private void DisplayLines()
        {
            for (int i = 0; i < _modulesObject.lineNames.Count; i++)
            {
                ...
                if (XButton())
                {
                    Undo.RecordObject(_modulesObject, "Delete Line");
        ...
        private void DisplayEmotions()
        {
            for (int i = 0; i < _modulesObject.emotionNames.Count; i++)
            {
                ...
                if (XButton())
                {
                    Undo.RecordObject(_modulesObject, "Delete Emotion");
        ...
        private void DisplayVoices()
        {
            for (int i = 0; i < _modulesObject.voices.Count; i++)
            {
                ...
                // Types
                Undo.RecordObject(_modulesObject, "Type type");
                ...
                if (Button("Delete " + voice.voice, 300))
                {
                    ...
                    {
                        Undo.RecordObject(_modulesObject, "Delete Voice");
        ...
        private void DisplayAutoFillBox()
        {
            ...
            if (tempObject)
            {
                ...
                {
                    Undo.RecordObject(_modulesObject, "Auto Fill Contents");
                    AutoFillContents();
                }
            }
        ...
        private void DisplayNewVoiceBox()
        {
            ...
            if (Button("Add", 100))
            {
                ...
                {
                    Undo.RecordObject(_modulesObject, "Add Voice");
        ...
        private void DisplayNewTypeBox()
        {
            ...
            if (Button("Add", 100))
            {
                ...
                {
                    Undo.RecordObject(_modulesObject, "Add Type");
        ...
        private void DisplayNewLineBox()
        {
            ...
            if (Button("Add", 100))
            {
                ...
                {
                    Undo.RecordObject(_modulesObject, "Add Line");
        ...
        private void DisplayNewEmotionBox()
        {
            ...
            if (Button("Add", 100))
            {
                ...
                {
                    Undo.RecordObject(_modulesObject, "Add Emotion");
