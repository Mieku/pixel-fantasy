...
{
    [CreateAssetMenu(fileName = "GearSettings", menuName = "Settings/Gear/Gear Settings")]
    public class GearSettings : CraftedItemSettings
    {
        [TitleGroup("Equipment")] public GearType Type;
        public bool CanBeDyed;
        [ShowIf("CanBeDyed")] public DyeSettings DefaultDyePalette;
