...
{
    public class DatabrainFoldoutElement : VisualElement
    {
        ...
        public DatabrainFoldoutElement(string _title, Action<bool> _onFoldoutCallback, params Action[] _additionalButtons)
        {
            totalHeight = 0;
