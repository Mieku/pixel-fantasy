...
{
    public class StorageBuildingPanel : BuildingPanel
    {
        [SerializeField] private StorageCategoryDetails _categoryDetailsPrefab;

        private List<StorageCategoryDetails> _displayedCategories = new List<StorageCategoryDetails>();
