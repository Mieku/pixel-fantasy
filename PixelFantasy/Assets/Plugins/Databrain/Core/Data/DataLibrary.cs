...
#pragma warning restore 0067
        ...
        async void CleanUp()
		{
			...
			var _assets = AssetDatabase.LoadAllAssetsAtPath(_assetPath);
        ...
        /// <summary>
        /// Get a runtime-DataObject by guid
        /// </summary>
		...
		/// <summary>
		/// Get initial-DataObject by Guid
		/// </summary>
		/// <param name="_guid"></param>
		/// <param name="_type"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Get runtime-DataObject by title
		/// </summary>
		...
		/// <summary>
		/// Get initial-DataObject by title
		/// </summary>
		/// <param name="_title"></param>
		/// <param name="_type"></param>
		/// <returns></returns>
		...
		public DataObject CloneDataObjectToRuntime(DataObject _data, GameObject _ownerGameObject = null)
		{
			...
			if (runtimeLibrary == null)
			{
				Debug.LogError("Warning no runtime datacore object. Please create one in the save&load module");
				return null;
			}
